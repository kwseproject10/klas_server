...
router.get("/", (req, res) => {
  ...
  const query =
    "SELECT concat(l.majID,'-',l.lecLv,'-',l.subID,'-',l.clsNum) as ID,lecName,m.majName,lecType,lecCre,lecHour,lecProf,lecTime,lecRm FROM lectures as l, majors as m where l.majID = m.majID";
  /*
