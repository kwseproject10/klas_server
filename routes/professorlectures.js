...
router.get("/", (req, res) => {
  ...
  const query =
    "select lecName,lecProf professor,majName major,lecType,lecCre credit,lecHour numOfTime, lecTime,lecRm place,concat(l.majID,'-',l.lecLv,'-',l.subID,'-',l.clsNum) as ID from lectures l join klas_db.users u on u.userName = l.lecProf join majors as m on l.majID=m.majID where u.userID = ? and l.lecyear = 2023";
  /*
